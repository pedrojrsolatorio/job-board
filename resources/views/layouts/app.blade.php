...
<body>
    ...
    <nav class="sticky top-0 z-50 border-b border-white/5 bg-[#060d1f]/95 backdrop-blur-md">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                ...
                <!-- Logo -->
                <a href="{{ route('home') }}" class="mr-2 flex items-center gap-3">
                ...
                <!-- Center nav links -->
                <div class="hidden items-center md:flex md:gap-3 lg:gap-8">
                    ...
                    @auth
                        ...
                        @if (auth()->user()->isEmployer())
                            <a href="{{ route('my-jobs.index') }}"
                                class="nav-link text-center text-xs text-slate-400 transition-colors hover:text-white md:ml-2 md:text-sm">My
                                Jobs</a>
                        @elseif(auth()->user()->isJobSeeker())
                            <a href="{{ route('my-applications') }}"
                                class="nav-link text-center text-xs text-slate-400 transition-colors hover:text-white md:text-sm">My
                                Applications</a>
                        @endif
    ...
    <!-- ===== FOOTER ===== -->
    <footer class="mt-24 border-t border-white/5 bg-[var(--navy-900)]">
